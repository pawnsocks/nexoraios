...
enum Keychain {
    static let service = "org.nexora.anime.session"
    static func store(_ token: String) throws {
        ...
        guard SecItemAdd(item as CFDictionary, nil) == errSecSuccess else { throw APIError.message("Unable to save your login securely.") }
    }
